...
from flask import session, request, current_app, redirect, url_for, render_template
    ...
    def decorated_function(*args, **kwargs):
        try:
            ...
            if not (session.sid == session_key and session.__contains__(SessionResources().const.MEMBER_ID)):
                ...
                return redirect(url_for(RouteResources().const.SIGN_IN_NEWPAGE, to=f.__name__, params=kwargs))
