...
class LanguageResources(object):
    ...
    const.SolvedPeople = ['맞춘 사람', 'Solved People']
    ...
    const.ArticleContent = ['내용', 'Content']
    const.ArticleMemberId = ['작성자', 'ID']
    ...
    const.School = ['학교', 'School']
    const.Lyceum = ['학원', 'Lyceum']
    const.Company = ['기업', 'Company']
    const.Etc = ['기타', 'Etc']
    ...
    '''
    const.ProblemSet = ['문제집', 'Problem Set']
    const.MyProblemSet = ['내 문제집', 'My Problem Set']
    const.PublicProblemSet = ['공유 문제집', 'Public Problem Set']
    const.ProblemSetWriter = ['작성자', 'Writer']
